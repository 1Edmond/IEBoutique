                  ...
                  <div class="row" >
                    ...
                    <div class="col-6 col-sm-3">
                      <select name="Trie" class="form-control">
                        ...
                        <option value="Site"  class="text-center text-truncate" style="max-width: 150px;">Site Web</option>
                        <option value="Date"  class="text-center text-truncate" style="max-width: 150px;">Date</option>
                      </select>
                    </div>
                    <div class="col-6 col-sm-3">
                      <select name="Order" class="form-control">
                        <option value="asc"  class="text-center text-truncate" style="max-width: 150px;">Croissant</option>
                        <option value="desc"  class="text-center text-truncate" style="max-width: 150px;">Décroissant</option>
                      </select>
                    </div>
                ...
                <table id="order-listing" class="table table-hover table-responsive">
                  <thead>
                    <tr>
                        ...
                        <th  class="text-center text-truncate" style="max-width: 150px;">Nbr utilisateurs</th>
                        {{--<th>Status</th>--}}
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td  class="text-center text-truncate" style="max-width: 150px;">{{$value->Adresse}}</td>
                      <td  class="text-center text-truncate" style="max-width: 150px;">{{$value->Email}}</td>
                      <td  class="text-center text-truncate" style="max-width: 150px;">{{$value->Site}}</td>
                      <td  class="text-center text-truncate" style="max-width: 150px;">{{$value->DateAjout}}</td>
                      <td  class="text-center text-truncate" style="max-width: 150px;">{{$value->Etat}}</td>
                      ...
                      <td  class="text-center text-truncate" style="max-width: 150px;">
                        <a class="btn btn-outline-primary" title="Detailler {{$value->Nom}}" href="{{route('Admin.Boutique.Details',['id'=>$value->id])}}">Voir</a>
                      </td>
                      </tr>
                      @empty
                          <tr>
                  ...
                  <tfoot>
                    <tr>
                      <form action="{{route('Admin.Boutique.Search')}}" method="GET" class="form">
                        <td><input class="form-control" placeholder="Recherche par nom" type="text" name="Nom" ></td>
                        <td><input class="form-control" placeholder="Recherche par Adresse" type="text" name="Adresse" ></td>
                        <td><input class="form-control" placeholder="Recherche par email" type="text" name="Email" ></td>
                        <td><input class="form-control" placeholder="Recherche par Site" type="text" name="Site" ></td>
                        <td colspan="3" class="text-center">
                          <button class="btn btn-primary " title="Rechercher" type="submit"> <i class="fa fa-search"></i></button>
                        </td>
                      </form>
                    </tr>
                  </tfoot>
